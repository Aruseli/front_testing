...
const resources = {
  en: {
    translation: {
      ...
      'flag-title--all-languages': 'Any languages and stacks',
      ...
      'intro--choose': 'come in',
      'intro--choose_transparent': 'choose',
      ...
      'intro--business--find_team': 'find a team',
      'intro--write': 'write',
      'intro--in': 'in',
